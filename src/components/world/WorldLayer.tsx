...
const themeGradients: Record<WorldTheme, string> = {
  ...
  "pinterest-blush": "radial-gradient(ellipse at 40% 30%, hsl(10 80% 97% / 0.95) 0%, hsl(350 50% 95%) 40%, hsl(140 25% 90%) 100%)",
...
const themeVignettes: Record<WorldTheme, string> = {
  ...
  "pinterest-blush": "radial-gradient(ellipse at center, transparent 50%, hsl(350 40% 85% / 0.12) 100%)",
...
const themeColors: Record<WorldTheme, { particle: string; glow: string }> = {
  ...
  "pinterest-blush": { particle: "hsl(350 55% 78%)", glow: "hsl(140 30% 75%)" },
